...
function checkId(){
	...
	var url = "location.href='history.back()'";
			...
			<div class="col-12 w-100" id="service-range" >
				<div class="col-12 w-100">
					<div class="row justify-content-center m-2 radius1">	
						<div class="col-4">
							<button class="col-5 svc_range" name="svc_range" type="button" value="2" onclick="act_range()">2Km</button>
						</div>
						<div class="col-4">
							<button class="col-5 svc_range" name="svc_range" type="button" value="5" onclick="act_range()">5Km</button>
						</div>
						<div class="col-4">
							<button class="col-5 svc_range" name="svc_range" type="button" value="10" onclick="act_range()">10Km</button>
						</div>
					</div>	
					<div class="row justify-content-center m-2 mb-5 radius1">	
						<div class="col-4">
							<button class="col-5 svc_range" name="svc_range" type="button" value="25" onclick="act_range()">25Km</button>
						</div>
						<div class="col-4">
							<button class="col-5 svc_range" name="svc_range" type="button" value="50" onclick="act_range()">50Km</button>
						</div>
						<div class="col-4">
							<button class="col-5 svc_range" name="svc_range" type="button" value="100" onclick="act_range()">100Km</button>
						</div>
					</div>
				</div>
			</div>
...
function act_range(){
	    ...
	    if($(this).prop("onclick")){
	        $("button[name='svc_range']").css("color","blue");
	    }else{
	    	 $("button[name='svc_range']").css("color","red");
	    }
