...
<script type="text/javascript">
	function checkWrite() {
		...
		if(document.write.post_title.value == ""){
			alert("제목을 입력하십시오!");
			return;
		}else if(document.write.post_content.value == ""){
			alert("내용을 입력하십시오!")
			return;
		}
...
<div class="container" align="center">
	<form action="${ pageContext.request.contextPath }/post/write" method="post" id="w" name = "write" enctype="multipart/form-data">
		<c:if test="${!empty post_seq }">
			<input type="hidden" name="post_seq" value="${post_seq }">
		</c:if>
		<table class = "postTable">
			<tr>
				<th width="60">제목</th>
				<td><input type="text" name = "post_title" size = "53"></td>
			</tr>
			<tr>
				<td colspan="2">
					<textarea class="summernote" rows="15" cols="60" name="post_content"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2">
