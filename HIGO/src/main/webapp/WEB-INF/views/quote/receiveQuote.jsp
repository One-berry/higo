          ...
          <div class="row card-body">
            <div class="col-md-4 mb-4 mb-md-0">
              <div class="post-slider slider-sm slick-initialized slick-slider"><button type="button" class="prevArrow slick-arrow" style=""><i class="ti-angle-left"></i></button>
                <div class="slick-list draggable"><img src="${pageContext.request.contextPath }/resources/images/coffee.jpg" class="card-img slick-slide slick-cloned" alt="post-thumb" style="height: 200px; object-fit: cover; width: 220px;" data-slick-index="-1" aria-hidden="true" tabindex="-1"></div></div>
              ...
              <ul class="card-meta list-inline">
                <li class="list-inline-item">
                  <a href="author-single.html" class="card-meta-author">
                    <img src="${ pageContext.request.contextPath }/resources/images/soju.jpg" alt="John Doe">
                    <span>${gosu_id }</span>
                  </a>
                </li>
                <li class="list-inline-item">
