...
public class LoginController {
	...
	@RequestMapping("/login/check")
	   public String loginCheck(MemberVO vo,HttpServletRequest request,HttpServletResponse response,HttpSession session) {
	      
	      System.out.println(vo.getPassword());
	      System.out.println(vo.getId());
	      int member_seq = memberService.checkLogin(vo);   
	      int gosu_seq = gosuService.checkLogin(member_seq);
	      System.out.println(gosu_seq + "sdfsdfsdfsdf" + member_seq);
	      try {
...
//	      }
	      ...
	      if(vo.getMember_seq() != 0){
	         ...
	         if(gosu_seq != 0) {
	            ...
	            System.out.println(gosu_seq + "sdfsdfsdfsdf");
